...
<div>
    <div class="p-3 text-white rounded-top  bg-dark">
...
<div class="container">
    <div class="row row-cols-5">
        ...
        <span class="col border border-dark p-2 p-relative glass">
...
<style>
  ...
  .glass{
    background: rgba(0, 0, 0, 0.2); /* transparent white wash */
    backdrop-filter: blur(3px);           /* blur behind it */
