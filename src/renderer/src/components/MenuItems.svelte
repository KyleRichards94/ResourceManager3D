...
<div class="row align-items-center justify-content-center pb-3 border-top p-3" >
  <div on:click={() => CurrentView.set(Views.CpuInfo)} class="col menuitem {$CurrentView === Views.CpuInfo ? 'selected-item scanlines' : ''}" style="cursor: pointer;">
  ...
  <div on:click={() => CurrentView.set(Views.MemoryInfo)} class="col menuitem {$CurrentView === Views.MemoryInfo ? 'selected-item scanlines' : ''}" style="cursor: pointer;">
        <ThreeRender _Title="Cpu Info menu" 
          _RenderHeight={_WidthHeight}
          _RenderWidth={_WidthHeight}
          _Style="cursor:pointer" 
  ...
  <div on:click={() => CurrentView.set(Views.GPUInfo)} class="col menuitem {$CurrentView === Views.GPUInfo ? 'selected-item scanlines' : ''}" style="cursor: pointer;">
        <ThreeRender _Title="Cpu Info menu" 
          _RenderHeight={_WidthHeight}
          _RenderWidth={_WidthHeight}
          _Style="cursor:pointer" 
  ...
  <div on:click={() => CurrentView.set(Views.DiskInfo)} class="col menuitem {$CurrentView === Views.DiskInfo ? 'selected-item scanlines' : ''}" style="cursor: pointer;">
        <ThreeRender _Title="Cpu Info menu" 
          _RenderHeight={_WidthHeight}
          _RenderWidth={_WidthHeight}
          _Style="cursor:pointer" 
  ...
  <div on:click={() => CurrentView.set(Views.NetworkInfo)} class="col menuitem {$CurrentView === Views.NetworkInfo ? 'selected-item scanlines' : ''}" style="cursor: pointer;">
        <ThreeRender _Title="Cpu Info menu" 
          _RenderHeight={_WidthHeight}
          _RenderWidth={_WidthHeight}
          _Style="cursor:pointer" 
...
@keyframes pulseGlow {
  from {
    box-shadow: 0 0 10px #00ffff55, inset 0 0 6px #00ffff33;
  }
  to {
    box-shadow: 0 0 14px #00ffffaa, inset 0 0 12px #00ffff66;
  }
}
