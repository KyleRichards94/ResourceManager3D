...
if (process.contextIsolated) {
  try {
    ...
    contextBridge.exposeInMainWorld('api', {
      ...
      getMemLayout: () => ipcRenderer.invoke('get-mem-layout-info'),
      getFSSize: () => ipcRenderer.invoke('get-fs-size'),
      getFSStats: () => ipcRenderer.invoke('get-fs-stats'),
      getFSDisksIO: () => ipcRenderer.invoke('get-fs-disk-io'),
      ...
      getNvidiaGpuInfo: () => ipcRenderer.invoke('get-nvidia-gpu-info'),
      getPowerDraw: () => ipcRenderer.invoke('get-power-draw-info')
    })
  } catch (error) {
    console.error(error)
  }
