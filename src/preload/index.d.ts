...
type UseCases = {
  ...
  getNetworkConnections: () => Promise<si.Systeminformation.NetworkConnectionsData[]>;
  getWifiNetworks: () => Promise<si.Systeminformation.WifiNetworkData[]>;
  getWifiInterfaces: () => Promise<si.Systeminformation.WifiInterfaceData[]>;
  getWifiConnections: () => Promise<si.Systeminformation.WifiConnectionData[]>;
